...
<body class="d-flex flex-column h-100">
    ...
    <footer class="footer mt-auto py-4">
        <div class="container">
            <hr class="my-4">
            <!-- copyright -->
            <div class="copyright text-center mb-2 mb-md-0">&copy; <?php date('Y') ?> - <a href="https://niscaya.id" target="_blank" class="text-brand text-decoration-none">niscaya.id</a>. All rights reserved.
            </div>
        </div>
    </footer>
